...
def loading():
    ...
    file_data_to_load = [
            ...
            "Thank you for playing my game. I would greatly appreciate if you did this survey to give me feedback for the game, so I can improve it. The url for the survey is https://goo.gl/forms/75EkF5X8VZ2lhhtb2"
        ]
    count = 0
